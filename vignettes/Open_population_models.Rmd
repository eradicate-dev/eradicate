...
which indicates there are around 12 rabbits remaining at the start of the last trapping session. Since 7 rabbits were subsequently removed during the last session, the population of rabbits remaining was 5.
